...
\teachingposition{Coding Instructor}
...
\teachingseminars{Troubleshooting Office Hours}
    {UC San Diego Teaching + Learning Commons}
    {14 November 2019}
\teachingseminars{Grading Fairly and Efficiently}
    {UC San Diego Teaching + Learning Commons}
    {21 January 2020}
\teachingseminars{Fostering Growth Mindset}
    {UC San Diego Teaching + Learning Commons}
    {28 February 2020}
